...
One of three sibling repos in the Petrimonium ecosystem — see
[`docs/ECOSYSTEM.md`](docs/ECOSYSTEM.md) for this repo's job, current status,
and how it relates to `petrimonium-wallet` and `petrimonium-backend`.
